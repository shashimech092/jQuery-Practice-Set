...
$("p").click();
    ...
    //  $('p').hide();  // by click p will hide
    // $(this).hide();  // by clicking particular will be hide when having more p
    //  $('#id').hide();
    //  $('.class').hide();
       });
...
$('p:first').click() // clicks on all the elements elements
